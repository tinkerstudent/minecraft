...
public class SnitchModel extends ModelBase
{
...
//        modelrenderer.addBox(-8.0F, -12.0F, -4.0F, 6, 8, 2);
...
//        this.batHead.addChild(modelrenderer1);
        ...
        this.batBody.addBox(-3.0F, 4.0F, -3.0F, 6, 6, 6);
//        this.batBody.setTextureOffset(0, 34).addBox(-5.0F, 16.0F, 0.0F, 10, 6, 1);
        this.batRightWing = new ModelRenderer(this, 42, 0);
        this.batRightWing.addBox(-12.0F, 1.0F, 1.5F, 2, 2, 2);
//        this.batOuterRightWing = new ModelRenderer(this, 24, 16);
//        this.batOuterRightWing.setRotationPoint(-12.0F, 1.0F, 1.5F);
//        this.batOuterRightWing.addBox(-8.0F, 1.0F, 0.0F, 8, 12, 1);
        this.batLeftWing = new ModelRenderer(this, 42, 0);
        this.batLeftWing.mirror = true;
        this.batLeftWing.addBox(2.0F, 1.0F, 1.5F, 2, 2, 2);
//        this.batOuterLeftWing = new ModelRenderer(this, 24, 16);
//        this.batOuterLeftWing.mirror = true;
//        this.batOuterLeftWing.setRotationPoint(12.0F, 1.0F, 1.5F);
//        this.batOuterLeftWing.addBox(0.0F, 1.0F, 0.0F, 8, 12, 1);
//      this.batBody.addChild(this.batOuterRightWing);
//      this.batBody.addChild(this.batOuterLeftWing);
